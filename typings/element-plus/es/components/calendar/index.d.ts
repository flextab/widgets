export declare const ElCalendar: import("element-plus/es/utils").SFCWithInstall<
    import("vue").DefineComponent<
        ...
        },
        {
            ...
            calculateValidatedDateRange: (
                startDayjs: import("dayjs").Dayjs,
                endDayjs: import("dayjs").Dayjs
                        ...
                        import("@vue/shared").LooseRequired<
                            Readonly<
                                import("vue").ExtractPropTypes<{
                                    ...
                                    readonly hideHeader: {
                                        readonly type: import("vue").PropType<
                                            import("element-plus/es/utils").EpPropMergeType<BooleanConstructor, unknown, unknown>
                                        >;
                                        readonly required: false;
                                        readonly validator: ((val: unknown) => boolean) | undefined;
                                        __epPropKey: true;
