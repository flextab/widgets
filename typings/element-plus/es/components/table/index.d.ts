...
export declare const ElTable: import("element-plus/es/utils").SFCWithInstall<
            ...
            tooltipOptions: import("vue").PropType<
                | Partial<
                      Pick<
                          ...
                          "offset" | "effect" | "placement" | "popperClass" | "showAfter" | "hideAfter" | "popperOptions" | "enterable" | "showArrow"
                      >
                  >
                | undefined
            >;
            spanMethod: import("vue").PropType<
                | ((data: { row: any; rowIndex: number; column: import("./src/table-column/defaults").TableColumnCtx<any>; columnIndex: number }) =>
                      | number[]
                      | {
                            rowspan: number;
                            colspan: number;
        ...
        Readonly<
            import("vue").ExtractPropTypes<{
                ...
                load: import("vue").PropType<
                    ((row: any, treeNode: import("./src/table/defaults").TreeNode, resolve: (data: any[]) => void) => void) | undefined
                >;
                style: {
                    type: import("vue").PropType<import("vue").CSSProperties>;
                    default: () => {};
    ...
    TableColumn: import("vue").DefineComponent<
        {
            ...
            renderHeader: import("vue").PropType<
                (data: { column: import("./src/table-column/defaults").TableColumnCtx<any>; $index: number }) => import("vue").VNode<
...
export declare const ElTableColumn: import("element-plus/es/utils").SFCWithInstall<
    import("vue").DefineComponent<
        {
            type: {
                type: StringConstructor;
