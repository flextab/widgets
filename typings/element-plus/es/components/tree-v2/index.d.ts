export declare const ElTreeV2: import("element-plus/es/utils").SFCWithInstall<
    import("vue").DefineComponent<
        {
            readonly data: import("element-plus/es/utils").EpPropFinalized<
                | (new (...args: any[]) => import("./src/types").TreeData)
                | (() => import("./src/types").TreeData)
                | ((new (...args: any[]) => import("./src/types").TreeData) | (() => import("./src/types").TreeData))[],
                unknown,
                unknown,
                () => [],
                boolean
            ...
            readonly props: import("element-plus/es/utils").EpPropFinalized<
                | (new (...args: any[]) => import("./src/types").TreeOptionProps)
                | (() => import("./src/types").TreeOptionProps)
                | ((new (...args: any[]) => import("./src/types").TreeOptionProps) | (() => import("./src/types").TreeOptionProps))[],
                unknown,
                unknown,
            ...
            readonly defaultCheckedKeys: import("element-plus/es/utils").EpPropFinalized<
                | (new (...args: any[]) => import("./src/types").TreeKey[])
                | (() => import("./src/types").TreeKey[])
                | ((new (...args: any[]) => import("./src/types").TreeKey[]) | (() => import("./src/types").TreeKey[]))[],
                unknown,
                unknown,
                () => [],
                boolean
            ...
            readonly defaultExpandedKeys: import("element-plus/es/utils").EpPropFinalized<
                | (new (...args: any[]) => import("./src/types").TreeKey[])
                | (() => import("./src/types").TreeKey[])
                | ((new (...args: any[]) => import("./src/types").TreeKey[]) | (() => import("./src/types").TreeKey[]))[],
                unknown,
        ...
        },
        {
            props: Readonly<
                import("@vue/shared").LooseRequired<
                    ...
                    > & {
                        ...
                        "onNode-click"?:
                            | ((data: import("../tree/src/tree.type").TreeNodeData, node: import("./src/types").TreeNode, e: MouseEvent) => any)
                            | undefined;
                        "onNode-contextmenu"?:
                            | ((event: Event, data: import("../tree/src/tree.type").TreeNodeData, node: import("./src/types").TreeNode) => any)
                            | undefined;
                        "onNode-collapse"?: ((data: import("../tree/src/tree.type").TreeNodeData, node: import("./src/types").TreeNode) => any) | undefined;
                    }
                >
            >;
            emit: ((event: "current-change", data: import("../tree/src/tree.type").TreeNodeData, node: import("./src/types").TreeNode) => void) &
                ((event: "node-expand", data: import("../tree/src/tree.type").TreeNodeData, node: import("./src/types").TreeNode) => void) &
                ((event: "check-change", data: import("../tree/src/tree.type").TreeNodeData, checked: boolean) => void) &
                ((event: "node-click", data: import("../tree/src/tree.type").TreeNodeData, node: import("./src/types").TreeNode, e: MouseEvent) => void) &
                ((event: "node-contextmenu", event: Event, data: import("../tree/src/tree.type").TreeNodeData, node: import("./src/types").TreeNode) => void) &
                ((event: "node-collapse", data: import("../tree/src/tree.type").TreeNodeData, node: import("./src/types").TreeNode) => void) &
                ((event: "check", data: import("../tree/src/tree.type").TreeNodeData, checkedInfo: import("./src/types").CheckedInfo) => void);
            slots: Readonly<{
            ...
            FixedSizeList: import("vue").DefineComponent<
                {
                    ...
                    readonly containerElement: import("element-plus/es/utils").EpPropFinalized<
                        | (new (...args: any[]) => (string | Element) & {})
                        | (() => string | Element)
                        | ((new (...args: any[]) => (string | Element) & {}) | (() => string | Element))[],
                        unknown,
                        unknown,
                        "div",
                        boolean
                    >;
                    readonly data: import("element-plus/es/utils").EpPropFinalized<
                        (new (...args: any[]) => any[]) | (() => any[]) | ((new (...args: any[]) => any[]) | (() => any[]))[],
                        unknown,
                        unknown,
                        () => [],
                        boolean
                    ...
                    readonly height: {
                        readonly type: import("vue").PropType<
                            import("element-plus/es/utils").EpPropMergeType<readonly [StringConstructor, NumberConstructor], unknown, unknown>
                        >;
                        readonly required: true;
                        readonly validator: ((val: unknown) => boolean) | undefined;
                        __epPropKey: true;
                    };
                    readonly innerElement: import("element-plus/es/utils").EpPropFinalized<
                        readonly [StringConstructor, ObjectConstructor],
                        unknown,
                        unknown,
                        "div",
                        boolean
                    ...
                    readonly width: {
                        readonly type: import("vue").PropType<
                            import("element-plus/es/utils").EpPropMergeType<readonly [NumberConstructor, StringConstructor], unknown, unknown>
                        >;
                        readonly required: false;
                        readonly validator: ((val: unknown) => boolean) | undefined;
                        __epPropKey: true;
                    ...
                    readonly itemSize: {
                        readonly type: import("vue").PropType<
                            import("element-plus/es/utils").EpPropMergeType<
                                | (new (...args: any[]) => (number | import("..").ItemSize) & {})
                                | (() => number | import("..").ItemSize)
                                | ((new (...args: any[]) => (number | import("..").ItemSize) & {}) | (() => number | import("..").ItemSize))[],
                                never,
                                never
                            >
                        >;
                ...
                Readonly<
                    import("vue").ExtractPropTypes<{
                        ...
                        readonly layout: import("element-plus/es/utils").EpPropFinalized<
                            StringConstructor,
                            "horizontal" | "vertical",
                            never,
                            "vertical",
                ...
                },
                {
                    ...
                    readonly containerElement: import("element-plus/es/utils").EpPropMergeType<
                        | (new (...args: any[]) => (string | Element) & {})
                        | (() => string | Element)
                        | ((new (...args: any[]) => (string | Element) & {}) | (() => string | Element))[],
                        unknown,
            ...
            ElTreeNode: import("vue").DefineComponent<
                {
                    readonly node: import("element-plus/es/utils").EpPropFinalized<
                        | (new (...args: any[]) => import("./src/types").TreeNode)
                        | (() => import("./src/types").TreeNode)
                        | ((new (...args: any[]) => import("./src/types").TreeNode) | (() => import("./src/types").TreeNode))[],
                        unknown,
                        unknown,
                        () => import("element-plus/es/utils").Mutable<{
                            readonly key: -1;
                ...
                },
                {
                    props: Readonly<
                            ...
                            Readonly<
                                import("vue").ExtractPropTypes<{
                                    ...
                                    readonly indeterminate: import("element-plus/es/utils").EpPropFinalized<
                                        ...
                                        boolean
                                    >;
                                    readonly showCheckbox: import("element-plus/es/utils").EpPropFinalized<
                                        BooleanConstructor,
                                        unknown,
                                        unknown,
                                        false,
                                    ...
                                    readonly disabled: import("element-plus/es/utils").EpPropFinalized<BooleanConstructor, unknown, unknown, false, boolean>;
                                    readonly current: import("element-plus/es/utils").EpPropFinalized<BooleanConstructor, unknown, unknown, false, boolean>;
                                    readonly hiddenExpandIcon: import("element-plus/es/utils").EpPropFinalized<
                                        BooleanConstructor,
                                        unknown,
                                        unknown,
                                        false,
                        ...
                        >
                    >;
                    emit: ((event: "click", node: import("./src/types").TreeNode, e: MouseEvent) => void) &
                        ((event: "check", node: import("./src/types").TreeNode, checked: import("..").CheckboxValueType) => void) &
                        ((event: "toggle", node: import("./src/types").TreeNode) => void);
        ...
        import("vue").ComponentOptionsMixin,
        {
            ...
            "node-contextmenu": (
                event: Event,
                data: import("../tree/src/tree.type").TreeNodeData,
                node: import("./src/types").TreeNode
            ) => import("./src/types").TreeNode;
        },
        string,
        import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps,
